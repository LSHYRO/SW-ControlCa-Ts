...
const validarFechasT = () => {
    const ciclosV = props.ciclos.find(c => c.idCiclo === form.ciclos);
    return form.fecha_fin >= form.fecha_inicio &&
        form.fecha_inicio >= ciclosV.fecha_inicio && form.fecha_fin <= ciclosV.fecha_fin &&
        form.fecha_fin >= ciclosV.fecha_inicio && form.fecha_inicio <= ciclosV.fecha_fin;
}
