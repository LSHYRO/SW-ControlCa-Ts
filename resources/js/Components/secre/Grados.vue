...
import FormularioGrado from '@/Components/secre/FormularioGrado.vue';
...
const eliminarGrado = (idGrado, grado) => {
    ...
    swal.fire({
        ...
        if (result.isConfirmed) {
            form.delete(route('secre.eliminarGrados', idGrado));
        }
    ...
    swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            try {
                ...
                await form.delete(route('secre.elimGrados', $gradosIds));
