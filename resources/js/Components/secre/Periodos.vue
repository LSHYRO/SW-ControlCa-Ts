...
import FormularioPeriodos from '@/Components/secre/FormularioPeriodos.vue';
...
const eliminarPeriodo = (idPeriodo, periodo) => {
    ...
    swal.fire({
        ...
        if (result.isConfirmed) {
            form.delete(route('secre.eliminarPeriodos', idPeriodo));
        }
    ...
    swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            try {
                ...
                await form.delete(route('secre.elimPeriodos', $periodosIds));
