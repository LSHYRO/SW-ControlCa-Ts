...
import FormularioCiclos from '@/Components/secre/FormularioCiclos.vue';
...
const eliminarCiclo = (idCiclo, ciclo) => {
    ...
    swal.fire({
        ...
        if (result.isConfirmed) {
            form.delete(route('secre.eliminarCiclos', idCiclo));
        }
    ...
    swal.fire({
        ...
        if (result.isConfirmed) {
            try {
                ...
                console.log(ciclosS);
                await form.delete(route('secre.elimCiclos', $ciclosIds));
