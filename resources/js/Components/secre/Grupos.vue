...
import FormularioGrupo from '@/Components/secre/FormularioGrupo.vue';
...
const eliminarGrupo = (idGrupo, grupo) => {
    ...
    swal.fire({
        ...
        if (result.isConfirmed) {
            form.delete(route('secre.eliminarGrupos', idGrupo));
        }
    ...
    swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            try {
                ...
                await form.delete(route('secre.elimGrupos', $gruposIds));
