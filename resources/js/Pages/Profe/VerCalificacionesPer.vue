...
const botones = [{
    title: props.periodo.descripcion,
    extend: 'excelHtml5',
...
<template>
    <ProfeLayout :title="'Calificacion: ' + props.periodo.descripcion" :usuario="props.usuario">
        <div class="mt-8 bg-white p-4 shadow rounded-lg alturaM">
            <h2 class="text-black text-2xl text-center font-semibold p-5">{{ props.periodo.descripcion }}</h2>
            ...
            <div class="my-2">
                <p class="my-1">
                    <strong>Fecha de inicio: </strong> {{ props.periodo.fecha_i }}
                </p>
                <p class="my-1">
                    <strong>Fecha de entrega: </strong> {{ props.periodo.fecha_f }}
                </p>
            </div>
            <div class="w-full">
