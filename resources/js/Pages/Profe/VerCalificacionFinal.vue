...
const botones = [{
    title: props.clase['materias'].materia,
    extend: 'excelHtml5',
...
<template>
    <ProfeLayout :title="'Calificacion: ' + props.clase.materias.materia" :usuario="props.usuario">
        <div class="mt-8 bg-white p-4 shadow rounded-lg alturaM">
            <h2 class="text-black text-2xl text-center font-semibold p-5"> Calificacion: {{ props.clase.materias.materia }} </h2>
            ...
            <div class="my-2">
                <p class="my-1">
                    <strong>Ciclo escolar: </strong> {{ props.clase.descripcionCiclo }}
                </p>
            </div>
            <div class="w-full">
                <DataTable class="w-full table-auto text-sm display nowrap stripe compact cell-border order-column"
                    id="calificacionesFinales" name="calificacionesFinales" :columns="columns" :data="props.alumnos" :options="{
