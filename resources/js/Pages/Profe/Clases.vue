...
<template>
    <ProfeLayout title="Clases">
        <div class=" bg-white p-4 shadow rounded-lg alturaM">
            ...
            <div class="flex">
                <a v-for="clase in clases" :key="clase.idClase" :href="route('profe.mostrarClase', clase.idClase)"
                    ...
                    <div class="w-full rounded-t-lg fondo">
                        <div class="w-full rounded-t-lg filtro">
