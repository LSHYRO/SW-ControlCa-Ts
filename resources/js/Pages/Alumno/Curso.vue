...
import AlumnosSeccion from '@/Components/alumno/AlumnosSeccion.vue';
import Calificaciones from '@/Components/alumno/CalificacionesSeccion.vue';
...
console.log("Actividades en curso");
...
<template>
    <AlumnoLayout title="clases" :usuario="props.usuario">
        <div class="mt-8 bg-white p-4 shadow rounded-lg alturaM">
            ...
            <div v-if="mostrarCal">
                <Calificaciones :periodos="props.periodos" :claseA="props.claseA" :clasesA="props.clasesA" :calificacionPer="props.calificacionPer" :clasesFinal="props.clasesFinal"/>
            </div>
        </div>
    </AlumnoLayout>
</template>
