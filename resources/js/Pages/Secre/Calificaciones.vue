...
import FormElimCla from '@/Components/secre/FormularioElimClasCiclo.vue';
import FormCalifCiclo from '@/Components/secre/FormularioCalificacionCiclo.vue';
import FormPasCiclo from '@/Components/secre/FormularioPaseCiclo.vue';
...
const verCalificaciones = async (alumno) => {
    ...
    try {
        ...
        await axios.get(route('secre.verCalificaciones', { idAlumno }))
    } catch (error) {
    ...
    },
    {
        ...
        render: function (data, type, row, meta) {
            return `<div class="flex justify-center items-center">
                <a class="bg-cyan-500 hover:bg-cyan-600 text-white font-semibold py-2 px-4 rounded ver-calificaciones-btn" data-id="${row.idAlumno}" href="/secre/clasesAlumno/${ row.idAlumno }"">
                    Ver calificaciones
                </a>
            </div>`;
        }
...
<template>
    <SecreLayout title="Calificaciones" :usuario="props.usuario">
