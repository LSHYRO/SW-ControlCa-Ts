...
const update = () => {
    ...
    form.put(route('secre.actualizarContrasenia', form.idUsuario), {
        onSuccess: () => {
...
<template>
    <SecreLayout title="Perfil" :usuario="props.usuario">
                        ...
                        <div class="md:grid md:grid-cols-8">
                            <div class="col-span-4">
                                ...
                                <p class="m-3 text-sm text-gray-600 text-justify">
                                    Para realizar modificaciones a este tipo de informacion, es necesario acudir a la
                                    dirección.
                                </p>
                            </div>
                            <div class="col-span-4 m-2 md:grid md:grid-4">
                                <div class="col-span-3 sm:col-span-4 mt-2">
                                    ...
                                    <TextInput id="nombre_completo" v-model="props.directivo.nombre_completo" type="text"
                                        class="mt-1 block w-full" disabled />
                                </div>
                                <div class="col-span-6 sm:col-span-4 mt-2">
                                    <InputLabel for="fechaNac" value="Fecha de nacimiento" />
                                    <TextInput id="fechaNac" v-model="props.directivo.fechaNacimiento" type="date"
                                        class="mt-1 block w-full" disabled />
                                </div>
                                <div class="col-span-6 sm:col-span-4 mt-2">
                                    <InputLabel for="genero" value="Genero" />
                                    <TextInput id="genero" v-model="props.directivo['generos'].genero" type="text"
                                        class="mt-1 block w-full" disabled />
                                </div>
                                <div class="col-span-6 sm:col-span-4 mt-2">
                                    <InputLabel for="CURP" value="CURP" />
                                    <TextInput id="CURP" v-model="props.directivo.CURP" type="text" class="mt-1 block w-full"
                                        disabled />
                                </div>
                                <div class="col-span-6 sm:col-span-4 mt-2">
                                    <InputLabel for="RFC" value="RFC" />
                                    <TextInput id="RFC" v-model="props.directivo.RFC" type="text" class="mt-1 block w-full"
                                        disabled />
                                </div>
                                <div class="col-span-6 sm:col-span-4 mt-2">
                                    <InputLabel for="correoElectronico" value="Correo electronico" />
                                    <TextInput id="correoElectronico" v-model="props.directivo.correoElectronico" type="text"
                                        class="mt-1 block w-full" disabled />
                                </div>
                                <div class="col-span-6 sm:col-span-4 mt-2">
                                    <InputLabel for="numTelefono" value="Telefono" />
                                    <TextInput id="numTelefono" v-model="props.directivo.numTelefono" type="text"
                                        class="mt-1 block w-full" disabled />
                                </div>
                                <div class="col-span-6 sm:col-span-4 mt-2">
                                    <InputLabel for="tipoSangre" value="Tipo de sangre" />
                                    <TextInput id="tipoSangre" v-model="props.directivo['tipo_sangre'].tipoSangre" type="text"
                                        class="mt-1 block w-full" disabled />
                                </div>
                                <div class="col-span-6 sm:col-span-4 mt-2">
                                    <InputLabel for="alergias" value="Alergias" />
                                    <TextInput id="alergias" v-model="props.directivo.alergias" type="text"
                                        class="mt-1 block w-full" disabled />
                                </div>
                                <div class="col-span-6 sm:col-span-4 mt-2">
                                    <InputLabel for="discapacidad" value="Discapacidad" />
                                    <TextInput id="discapacidad" v-model="props.directivo.discapacidad" type="text"
                                        class="mt-1 block w-full" disabled />
                                </div>
                                <div class="col-span-6 sm:col-span-4 mt-2">
                                    <InputLabel for="direccion" value="Direccion" />
                                    <TextInput id="direccion" v-model="props.directivo.domicilio" type="text"
                                        class="mt-1 block w-full" disabled />
                                </div>
                            </div>
                        </div>
