...
import Ciclos from '@/Components/secre/Ciclos.vue';
import Periodos from '@/Components/secre/Periodos.vue';
...
<template>
    <SecreLayout title="Ciclos y Periodos" :usuario="props.usuario">
