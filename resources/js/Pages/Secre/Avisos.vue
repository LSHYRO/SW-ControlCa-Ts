...
import FormAvisos from '@/Components/secre/FormularioAvisos.vue'
...
const eliminarAviso = (idAviso, titulo) => {
    ...
    swal.fire({
        ...
        if (result.isConfirmed) {
            form.delete(route('secre.eliminarAv', idAviso));
        }
    ...
    swal.fire({
        ...
        if (result.isConfirmed) {
            try {
                ...
                await form.delete(route('secre.eliminarAvs', $avisosIds));
...
<template>
    <SecreLayout title="Avisos" :usuario="props.usuario">
