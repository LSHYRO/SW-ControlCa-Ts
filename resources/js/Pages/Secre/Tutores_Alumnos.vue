...
import Tutores from '@/Components/secre/Tutores.vue';
import Alumnos from '@/Components/secre/Alumnos.vue';
////////////////////////////////////////////////////////////////////////////////////////////////
...
<template>
    <SecreLayout title="Tutores y alumnos" :usuario="props.usuario">
        <div class="mt-8 bg-white p-4 shadow rounded-lg">
            ...
            <div v-if="alumnosB">
                <Alumnos :alumnos="props.alumnos" :talleres="props.talleres" :generos="props.generos" :grados="props.grados" :grupos="props.grupos" :tipoSangre="props.tipoSangre" :ciclos="props.ciclos"> </Alumnos>                
            </div>
        </div>
    </SecreLayout>
</template>