...
import TopContentAlumno from '@/Components/alumno/TopContentAlumno.vue'
import OpcionesNavAlumno from '@/Components/alumno/OpcionesNavAlumno.vue';
...
<template>
    <div class="flex flex-col h-screen bg-gray-100">
        ...
        <TopContentAlumno :usuario="props.usuario"/>
                ...
                <nav>
                    <div class="w-60 h-16 justify-start items-center px-2 inline-flex">
                        ...
                        <div class="flex-col justify-start items-center inline-flex">
                            <div class="text-center text-black text-base font-semibold font-['DM Sans'] px-2">{{ props.usuario.alumnoNombre }}
                            </div>
